...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente c1 = new Cliente(1, "Fernando", "456.123.789-45", "ernando@email.com", "max");
        Cliente c2 = new Cliente(2, "Cesar", "123.123.789-45", "cesar@email.com", "teo");
        Cliente c3 = new Cliente(3, "Lucas", "456.123.789-45", "lucas@email.com", "max2");
        Cliente c4 = new Cliente(4, "CristinA", "456.123.789-45", "cristina@email.com", "Pluto");
